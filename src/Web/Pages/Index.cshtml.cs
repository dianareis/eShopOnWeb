...
namespace Microsoft.eShopWeb.Web.Pages
{
    public class IndexModel : PageModel
    {
        ...
        {
            CatalogModel = await _catalogViewModelService.GetCatalogItems(pageId ?? 0, Constants.ITEMS_PER_PAGE, "", catalogModel.BrandFilterApplied, catalogModel.TypesFilterApplied, convertPrice: true, HttpContext.RequestAborted); // TODO:
